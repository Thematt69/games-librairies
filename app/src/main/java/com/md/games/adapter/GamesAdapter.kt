...
class GamesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.item_vertical_game, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.gameStatus?.text = if (currentGame.status) {
            context.getString(R.string.dejaJoue)
        } else {
            context.getString(R.string.pasEncoreJoue)
        }
